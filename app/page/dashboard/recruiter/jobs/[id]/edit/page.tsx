...
export default function EditJobPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(error instanceof Error ? error.message : '求人情報の更新に失敗しました');
        } finally {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const imagesToDelete = [
                ...
                formData.event_photo_url
            ].filter(url => url && url.startsWith('/'));

            for (const imagePath of imagesToDelete) {
                await supabase.storage
                    .from('jobs')
                    .remove([imagePath.replace('/', '')]);
            }
            ...
            setError(error instanceof Error ? error.message : '求人情報の削除に失敗しました');
        } finally {
            setIsDeleting(false);
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">求人情報を編集してください</p>
                    </div>
                ...
                <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            <AlertDialogTitle>求人情報を削除しますか？</AlertDialogTitle>
                            <AlertDialogDescription>
                                この操作は取り消せません。求人情報と関連する画像がすべて削除されます。
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
